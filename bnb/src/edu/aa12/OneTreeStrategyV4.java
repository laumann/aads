 ...
 * Time: 4:06 PM
 *
 * Strategy: like V3, just without the "stupid case" check, ignoring previous decisions
 *
 * use all prev decisions for mst
 * choose ot-vertex, s.t. it's not in previous decisions if possible
 */
public class OneTreeStrategyV4 extends OneTreeStrategy {
    @Override
